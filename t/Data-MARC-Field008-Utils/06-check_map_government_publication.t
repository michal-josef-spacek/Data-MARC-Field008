...
use Data::MARC::Field008::Utils qw(check_map_government_publication);
...
my $ret = check_map_government_publication($self, 'key');
...
$ret = check_map_government_publication($self, 'key');
...
$self = {};
eval {
	check_map_government_publication($self, 'key');
};
